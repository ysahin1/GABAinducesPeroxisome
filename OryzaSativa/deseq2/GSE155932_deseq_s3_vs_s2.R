...
##################################################
GSE155932_raw_counts <- GSE155932_raw_counts[,c(16,7,8,9)] #c(1:7),10) exclude all information that do not include counts
...
length(dn_GSE155932)
write.csv(dds_GSE155932_results[dn_GSE155932,],"S3_vs_S2_degs.csv")
