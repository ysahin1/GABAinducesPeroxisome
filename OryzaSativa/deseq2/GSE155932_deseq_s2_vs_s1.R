...
##################################################
GSE155932_raw_counts <- GSE155932_raw_counts[,c(14,15,16,7)] #c(1:7),10) exclude all information that do not include counts
...
length(dn_GSE155932)
write.csv(dds_GSE155932_results[dn_GSE155932,],"S2_vs_S1_degs.csv")
