...
##################################################
SRP014652v_raw_counts <- SRP014652v_raw_counts[,c(19,20,26,27,28)] #c(1:7),10) exclude all information that do not include counts
...
SRP014652v_grow_CG <- c(#"topmost_leaf_v3",
                        ...
                        #"thirteenth_leaf_r2",
                        #"thirteenth_leaf_r2")
SRP014652v_grow_CG <- factor(SRP014652v_grow_CG, levels = c("immature_Leaves_v9","eighth_leaf_v9"))
...
par(mfrow = c (1 ,2), cex.axis=0.5)
  tiff(filename = "im_eight.tiff", units = "mm" , width = 850, height = 300, res=600)
boxplot(sfn_dds_SRP014652v, notch = TRUE,
        main = "URCOEVIL", 
        ylab = "",
        las = 2,)
boxplot(ln_dds_SRP014652v , notch = TRUE ,
          main = "Log2-TSFNGAOEVIL" ,
          ylab = "",
        las=2)
dev.off()
...
write.csv(dds_SRP014652v_results[dn_SRP014652v,],"8th_vs_im_degs.csv")
