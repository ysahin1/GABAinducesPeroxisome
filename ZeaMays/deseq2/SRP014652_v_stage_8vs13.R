...
##################################################
SRP014652v_raw_counts <- SRP014652v_raw_counts[,c(19,20,23,24)] #c(1:7),10) exclude all information that do not include counts
...
SRP014652v_grow_CG <- c(#"topmost_leaf_v3",
                        ...
                        #"thirteenth_leaf_r2",
                        #"thirteenth_leaf_r2")
SRP014652v_grow_CG <- factor(SRP014652v_grow_CG, levels = c("eighth_leaf_v9","thirteenth_leaf_v9"))
...
write.csv(dds_SRP014652v_results[dn_SRP014652v,],"13th_vs_8th_degs.csv")
