...
##################################################
SRP014652v_raw_counts <- SRP014652v_raw_counts[,c(29,30,31,32)] #c(1:7),10) exclude all information that do not include counts
...
SRP014652v_grow_CG <- c(#"topmost_leaf_v3",
                        ...
                        "thirteenth_leaf_r2",
                        "thirteenth_leaf_r2")
SRP014652v_grow_CG <- factor(SRP014652v_grow_CG, levels = c("thirteenth_leaf_vT","thirteenth_leaf_r2"))
...
write.csv(dds_SRP014652v_results[dn_SRP014652v,],"R2_vs_VT_degs.csv")
