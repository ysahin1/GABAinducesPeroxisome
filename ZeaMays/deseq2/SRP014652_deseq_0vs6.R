...
##################################################
SRP014652_raw_counts <- SRP014652_raw_counts[,-c(1:6,9,10,11,12,13,14,15,18)] #c(1:7),10) exclude all information that do not include counts
...
length(dn_SRP014652)
write.csv(dds_SRP014652_results[dn_SRP014652,],"6DPA_vs_0DPA_degs.csv")
