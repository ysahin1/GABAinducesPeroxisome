...
##################################################
SRP014652v_raw_counts <- SRP014652v_raw_counts[,c(21,22,26,27,28)] #c(1:7),10) exclude all information that do not include counts
...
SRP014652v_grow_CG <- c(#"topmost_leaf_v3",
                        ...
                        #"thirteenth_leaf_r2",
                        #"thirteenth_leaf_r2")
SRP014652v_grow_CG <- factor(SRP014652v_grow_CG, levels = c("immature_Leaves_v9","eleventh_leaf_v9"))
...
write.csv(dds_SRP014652v_results[dn_SRP014652v,],"11th_vs_im_degs.csv")
