...
##################################################
SRP014652_raw_counts <- SRP014652_raw_counts[,c(9,10,14,15)] #c(1:7),10) exclude all information that do not include counts
...
length(dn_SRP014652)
write.csv(dds_SRP014652_results[dn_SRP014652,],"30DPA_vs_6DPA_degs.csv")
