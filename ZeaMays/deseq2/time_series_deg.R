...
##################################################
SRP014652v_raw_counts <- SRP014652v_raw_counts[,c(21:25)] #c(1:7),10) exclude all information that do not include counts
dim(SRP014652v_raw_counts)
...
#SRP014652v_grow_CG <- relevel(SRP014652v_grow_CG, ref = "eleventh_leaf_v9")
####################################
