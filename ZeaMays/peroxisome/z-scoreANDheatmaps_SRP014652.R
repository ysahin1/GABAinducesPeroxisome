...
tiff(filename = "SRP014652_peroxisome.tiff", units = "in", width = 10, height = 16, res=600)
pheatmap(DEperox_zscore_SRP014652,
         show_rownames=T, cluster_cols=F, cluster_rows=T, scale="row",annotation_col = SRP014652_coln,
         cex=1, clustering_distance_rows="euclidean", labels_row =  paste(sm_perox_SRP014652,perox_SRP014652_de ,sep = "-"),
