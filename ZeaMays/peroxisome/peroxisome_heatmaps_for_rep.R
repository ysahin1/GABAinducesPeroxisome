...
nperDEG
# match the symbols
perox_vstc_SRP014652 <- vstc_dds_SRP014652[which( rownames(vstc_dds_SRP014652) %in% c("Zm00001d050339",
                                                     "Zm00001d025626",
                                                     "Zm00001d028834",
                                                     "Zm00001d002834",
                                                     "Zm00001d027366",
...
png(filename = "im_vs_8.png", units = "in", width = 6, height = 4, res=600)
